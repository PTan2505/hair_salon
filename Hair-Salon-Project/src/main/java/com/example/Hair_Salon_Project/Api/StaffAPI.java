...
// public ResponseEntity<Bill> updateBill(@PathVariable Long id, @Valid
...
// public ResponseEntity<List<Booking>> getBookingsByStaff(@PathVariable Long
// staffId) {
...
// public ResponseEntity<List<PayRoll>> getSalariesByStaff(@PathVariable Long
// staffId) {
// List<PayRoll> salaries = salaryService.getSalariesByStaff(staffId);
...
// public ResponseEntity<List<Feedback>> getFeedbacksByStaff(@PathVariable Long
// staffId) {
