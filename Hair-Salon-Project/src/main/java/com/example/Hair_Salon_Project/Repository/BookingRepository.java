...
public interface BookingRepository extends JpaRepository<Booking, Long> {
    ArrayList<Booking> findByAccount(Account account);

    ArrayList<Booking> findByAccountIdAndBookingDate(Long accountId, LocalDate bookingDate);

    ArrayList<Booking> findByStaffIdAndBookingDate(Long staffId, LocalDate bookingDate);
