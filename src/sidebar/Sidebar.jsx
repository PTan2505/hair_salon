            ...
            <Nav className="flex-column custom-nav" activeKey={location.pathname}>
                {role === 'admin' && (
                    <>
                        ...
                        <Nav.Link as={Link} to={'/appointment/waiting'} eventKey={'/appointment/waiting'} className="custom-navlink">Appointment Request</Nav.Link>
                        <Nav.Link as={Link} to={'/appointment/accepted'} eventKey={'/appointment/accepted'} className="custom-navlink">Appointment</Nav.Link>
                        <Nav.Link as={Link} to={'/appointment/all'} eventKey={'/appointment/all'} className="custom-navlink">All Appointment</Nav.Link>
